...
:dtuC2O
cls
echo * DISABLE INTERNET CONNECTION ON RECIEVING CONSOLE BEFORE RUNNING DTU *
echo.
echo.
...
echo.
echo.
echo Once the message "Waiting to transfer data" appears, switch over to the OFW console.
echo.
echo.
echo.
...
:nfRun
cls
echo Now run the Netflix app and wait until it loads completely
echo.
...
echo.
echo.
echo Once DTU is finished, press ENTER to continue....
echo.
...
echo bin>>%ftpText%
echo cd /dev_hdd0/game/NPUP00030/USRDIR/APPDATA/>>%ftpText%
echo get PSID.dat %root%>>%ftpText%
echo quit>>%tempFile%
